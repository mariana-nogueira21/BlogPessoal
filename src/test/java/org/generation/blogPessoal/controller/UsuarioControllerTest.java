...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsario() {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(
				new Usuario(0L, "Mariana Nogueira", "mariana.nogueira21@email.com", "12345678"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Maria da Silva", "maria@email.com", "1234560"));

		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(
				new Usuario(0L, "Maria da Silva", "maria@email.com", "1234560"));
